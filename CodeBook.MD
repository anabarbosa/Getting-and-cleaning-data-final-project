...
#### 1. Read the following tables in R
* features.txt
* activity_labels.txt
* x_test.txt
* y_test.txt
...
#### 5. Rename variables with appropriate labels

#### 6. Create a new tidy data set with the average of each variable for each activity and each subject